...
createServer({
    ...
    seeds(server) {
        ...
        server.create("user", { id: "789", email: "frank@i.com", password: "kebab", name: "Frank" })
    },
    routes() {
        this.namespace = "api"
        this.logging = false
        this.passthrough("https://firestore.googleapis.com/**") /* The passthrough avoids that mirage JS intercepts the reqiests, and passes them to firebase/firestore */
